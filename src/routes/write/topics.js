...
module.exports = function () {
    ...
    setupApiRoute(router, 'delete', '/:tid/state', [...middlewares], controllers_1.default.write.topics.deleteTopic);
    ...
    setupApiRoute(router, 'put', '/:tid/resolve', [...middlewares], controllers_1.default.write.topics.resolve);
    ...
    setupApiRoute(router, 'put', '/:tid/tags', [
        ...middlewares,
    ...
    setupApiRoute(router, 'put', '/:tid/thumbs/order', [
        ...middlewares,
